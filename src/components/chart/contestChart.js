  ...
  return (
    <div className={styles.chart}>
      <div className={styles.butt}>
        ...
        <button
          className={
            activeFilter === "BEFORE" ? styles.buttonactive : styles.button
          }
          type="button"
          onClick={() => {
            setActiveFilter("BEFORE");
          }}
        >
          BEFORE
        </button>
        <button
          className={
            activeFilter === "FINISHED" ? styles.buttonactive : styles.button
          }
          type="button"
          onClick={() => {
      ...
      <div className={styles.chartcomp}>
        <Chart
          ...
          data={{
            ...
            datasets: [
              {
                data: cfdata.filter(dataFilter).map((o) => {
                  return Number(o.durationSeconds);
                }),
